...
pioneer_track_width = 0.4  #[m] Distance betweent the two wheels of pioneer
...
goal_threshold = 0.3 #[m] The threshold distance at which robot is declared to be at goal 